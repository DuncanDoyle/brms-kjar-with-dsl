...
public class RulesTest {
	...
	public void test() throws Exception {
		...
		/*
		 * FactType simpleFactType = kieSession.getKieBase().getFactType("org.jboss.ddoyle.rules", "SimpleFact"); Object simpleFact; try {
		 * simpleFact = simpleFactType.newInstance(); } catch (InstantiationException ie) { throw new RuntimeException(ie); } catch
		 * (IllegalAccessException iae) { throw new RuntimeException(iae); } simpleFactType.set(simpleFact, "id", "1");
		 */
